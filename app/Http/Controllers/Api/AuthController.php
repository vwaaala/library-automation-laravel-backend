...
class AuthController extends Controller
{
    ...
    public function forget(Request $request)
    {
        ...
        return Mail::to('vwaaala@gmail.com')->send(new ForgetPassword($user->forget_token));
    }
    ...
    public function forget_token(Request $request)
    {
        ...
        return Mail::to('vwaaala@gmail.com')->send(new ForgetPassword(" your password is:  ".$temp_pass));
    }
